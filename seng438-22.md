...
| **Test Method Name**                  | **Partitions Covered**                                       |
|----------------------------------------|-------------------------------------------------------------|
| `testValueWithinRange`    | Value within range (valid)                    |
| `testValueAtLowerBound`         | Value at lower bound (valid)                                   |
| `testValueAtUpperBound`      | Value at upper bound (valid)                              |
| `testValueBelowRange`    | Value below range (valid)                  |
| `testValueAboveRange`         | Value above range (valid)                             |
| `testNegativeRange`      | Values within and outside a negative range (valid)                             |
| `testPositiveRange`      | Values within and outside a positive range (valid)                            |
